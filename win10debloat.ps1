...
$Form.text                       = "Windows 10 Debloat Fork By NaveenResearchTamil"
...
$urlwebsitelink                = New-Object system.Windows.Forms.Button
$urlwebsitelink.text           = "View Website"
$urlwebsitelink.width          = 232
$urlwebsitelink.height         = 30
$urlwebsitelink.location       = New-Object System.Drawing.Point(615,594)
$urlwebsitelink.Font           = New-Object System.Drawing.Font('Microsoft Sans Serif',10)

$urlinstagram                = New-Object system.Windows.Forms.Button
$urlinstagram.text           = "Instagram Link"
$urlinstagram.width          = 232
$urlinstagram.height         = 30
$urlinstagram.location       = New-Object System.Drawing.Point(615,712)
$urlinstagram.Font           = New-Object System.Drawing.Font('Microsoft Sans Serif',10)


$urlgotochannel                  = New-Object system.Windows.Forms.Button
$urlgotochannel.text             = "Goto YouTube Channel"
$urlgotochannel.width            = 232
$urlgotochannel.height           = 30
$urlgotochannel.location         = New-Object System.Drawing.Point(615,632)
$urlgotochannel.Font             = New-Object System.Drawing.Font('Microsoft Sans Serif',10)

$urlsocialmedia                    = New-Object system.Windows.Forms.Button
$urlsocialmedia.text               = "Follow In Social Media"
$urlsocialmedia.width              = 232
$urlsocialmedia.height             = 30
$urlsocialmedia.location           = New-Object System.Drawing.Point(615,672)
$urlsocialmedia.Font               = New-Object System.Drawing.Font('Microsoft Sans Serif',10)

$Form.controls.AddRange(@($Panel2,$Label3,$Label15,$Panel4,$PictureBox1,$Label1,$Label4,$Panel3,$ResultText,$Label10,$Label11,$urlwebsitelink,$urlgotochannel,$urlsocialmedia, $urlinstagram))
...
$urlgotochannel.Add_Click({
    Start-Process "https://youtube.com/c/naveenresearchtamil?sub_confirmation=1"
})

$urlwebsitelink.Add_Click({
    Start-Process "https://naveenganesan.com/"
})

$urlsocialmedia.Add_Click({
    Start-Process "https://naveenganesan.com/social/"
})

$urlinstagram.Add_Click({
    Start-Process "https://instagram.com/g1naveen"
})
...
$essentialtweaks.Add_Click({
    ...
    Start-BitsTransfer -Source "https://raw.githubusercontent.com/NaveenResearchTamil/Windows10Debloat_2021/master/ooshutup10.cfg" -Destination ooshutup10.cfg
...
Set-ItemProperty -Path "HKCU:\Software\Microsoft\Windows\CurrentVersion\Policies\Explorer" -Name "HideSCAMeetNow" -Type DWord -Value 1
    ...
    $ResultText.text = "`r`n" + "Essential Tweaks Completed" + "`r`n" + "`r`n" + "Status: Ready For Next Task"
})
